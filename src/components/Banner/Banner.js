...
function Banner() {
    return (
        <div className="banner mt-2 position-relative font-family-Ubuntu">
            <div className='position-absolute justify-content-center w-25 ms-5 d-flex h-100 flex-column animation-from-left z-1'>
            ...
            <img className='w-100 animation-from-right' src={bannerImg} alt='banner' />
        </div>
    );
}
